...
@st.cache_resource
def layer3_call(month, user_ratings):
    global hybrid
    hybrid.layer3(month)
...
with st.form("submit_form"):
    ...
    if submitted:
        ...
        with st.spinner("Getting recommendations. Please wait..."):
            ...
            output_no_seasonality = layer2_call(num_output, movie_ratings)[:num_output]
            output_no_seasonality = pd.DataFrame(output_no_seasonality)
            output_no_seasonality.columns=["Standard Recommendations"]
            
            layer3_call(selected_month_int, movie_ratings)
